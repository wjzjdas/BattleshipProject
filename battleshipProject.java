...
public class battleshipProject extends JFrame implements ActionListener {
	...
	public static void main(String[] args) throws IOException{
		...
		System.out.println("\n __________________________________________________________________________________________________________________________________________________________________\n"
                ...
                + " __________________________________________________________________________________________________________________________________________________________________");
		System.out.print("\nEnter 'r' to read the rules; Enter 't' to read the tutorial left by the AI; Enter 's' to start the game: ");
		...
		while (!input.equals("s")) {
			...
			if (input.equals("r")) {
				...
				System.out.print("\nEnter 'r' to read the rules; Enter 't' to read the tutorial; Enter 's' to start the game: ");
				...
				System.out.println("1. To place a ship, click on the button representing the ship and then click on the where you wish to put your ship\r\n"
						+ "2. After doing step 1, to rotate a ship, press \"Vertical\" or \"Horizontal\"\r\n"
						+ "3. To change an unconfirmed ship's position, repeat step 1\r\n"
						+ "4. After doing step 1, to confirm a ship's position(lock a ship's position), click on the \"confirm\" button\r\n"
						+ "5. After doing step 4, to remove a confirmed ship from its current position, click the \"remove\" button and type in console the number correlated to the ship\r\n"
						+ "6. The ships can be placed next to each other\r\n"
						+ "7. After placing all the ships down, click the \"start the game\" button to start the game"
						+ "8. After doing step 7, a random coin toss will determine whether you or the AI will go first.\r\n"
						+ "9. To attack a square, click on the square you wish to attack\r\n"
						+ "10. Good luck, player!\t\t\t--- The AI");
				System.out.print("\nEnter 'r' to read the rules; Enter 't' to read the tutorial; Enter 's' to start the game: ");
